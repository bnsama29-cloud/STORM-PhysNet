...
mean PE$_{1\mathrm{h}}\approx0.986$ and PE$_{6\mathrm{h}}\approx0.901$.
...
Alternative gates (RDG/RDG-S/SDG), a hybrid SSM backbone, magnetopause
features, and a spectral head were implemented as probes; they are not
primary systems. Full alt-gate tables appear in the companion Access manuscript.
...
available at
\url{https://github.com/bnsama29-cloud/STORM-PhysNet}. Note that the GRASP fine-tuning run, wider-delay retrain, and robustness/interpretability diagnostics were executed externally, and their frozen outputs are provided in the repository.
