...
- Adaptive solar-wind propagation delay constrained to 0.5–1.5 h
- Feature projection to 128 dimensions
- 2-layer, 4-head Transformer encoder
- Bz-conditioned modulation gate
- Residual prediction heads for 1 h / 6 h / 12 h forecasts
...
The IEEE manuscript PDF is intentionally not stored in this repository. The repository contains the corresponding implementation, figures, evaluation outputs, and checkpoints.
