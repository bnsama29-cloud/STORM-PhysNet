...
any strategy. Learned delays fall near \(1.5\,\mathrm{h}\) on the final evaluation checkpoints, consistent with residual L1--Earth transit under typical solar-wind speeds. Code: \url{https://github.com/bnsama29-cloud/STORM-PhysNet}.
\end{abstract}
