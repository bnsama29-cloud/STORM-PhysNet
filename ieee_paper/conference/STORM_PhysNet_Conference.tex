...
and concatenated with GOES log-flux (=72\,\mathrm{h}$), projected to
{\mathrm{model}}=128$, and encoded by a 2-layer, 4-head Transformer.
A $-conditioned gate modulates the final representation; three residual heads
with shared horizon embeddings (=16$) predict corrections over persistence
at 1\,h, 6\,h, and 12\,h.}
\label{fig:arch}
\end{figure*}
