...
(default hyperparameters: $d_{\mathrm{model}}=64$, 3 layers, 4 heads).
The two models differ in both width and depth; they are not capacity-matched.
Single-model PE differences should be interpreted with this disparity in mind.
