...
they are not capacity-matched. A capacity-matched Transformer control was
not trained; single-model PE differences should therefore be interpreted
with the parameter-count disparity in mind.
...
Because the Transformer baseline was not capacity-matched to STORM, we do not attribute single-model PE differences solely to the delay or gate modules.
