...
\tfootnote{This work extends a concurrent conference submission on the same system. The present manuscript adds the wider-delay ablation, the bagged-Transformer control, expanded interpretability diagnostics, and the full multi-seed GRASP transfer analysis.}
\markboth
