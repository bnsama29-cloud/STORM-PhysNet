...
\begin{figure}[!t]
\centering
\includegraphics[width=\columnwidth]{figures/fig_dashboard_storm_flux.png}
\caption{Example operational dashboard under disturbed solar-wind settings
(multi-horizon log-flux forecasts). For illustration; quantitative scores
