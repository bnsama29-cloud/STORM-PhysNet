...
and from seed-bagged STORM, while a capacity-matched bagged Transformer reaches
test PE\(_{6\mathrm{h}}=0.919\). Input-noise and missing-channel checks, together with GRASP fine-tuning
