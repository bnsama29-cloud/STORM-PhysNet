...
repository map in the ``Repository name map'' paragraph below.
...
\[
  h_{\mathrm{g}} = g_{\mathrm{RDG}}(v_{\mathrm{sw}}, B_z)\,\odot\,h,
\]
...
\midrule
1\,h & 0.820 $\pm$ 0.001 & 0.827 $\pm$ 0.009 & +0.007 \\
...
($0.986$ / $0.897$ / $0.851$), matching encoder width/depth shrinks the short-horizon
